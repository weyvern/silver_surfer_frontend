            ...
            <div className="card rounded-lg text-dark">
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-row pt-2">
                            <div className="form-group col-md-6"><label className="small text-gray-600" for="leadCapStreet" name="street">Street Address</label><input className="form-control rounded-pill" id="leadCapStreet" name="street" type="text" onChange={handleChange}/></div>
                            <div className="form-group col-md-3"><label className="small text-gray-600" for="leadCapState" name="state">State</label><input className="form-control rounded-pill" id="leadCapState" type="text" name="state" onChange={handleChange}/></div>
                            <div className="form-group col-md-3"><label className="small text-gray-600" for="leadCapZipcode" name="zipcode">Zipcode</label><input className="form-control rounded-pill" id="leadCapZipcode" name="zipcode" type="text" onChange={handleChange}/></div>
                        </div>
                        <div className="form-row justify-content-between pt-2">
                            <div className="form-group"><label className="small text-gray-600" for="leadCapPhone" name="phone">Phone Number</label><input className="form-control rounded-pill" id="leadCapPhone" name="phone" type="text" onChange={handleChange}/></div>
                            <div className="form-group"><label className="small text-gray-600" for="leadCapDob" name="dob">Birthday</label><input className="form-control rounded-pill" id="leadCapDob" name="dob" type="text" placeholder="e.g. 01.01.1990" onChange={handleChange} required/></div>
                        </div>
                        <div className="form-group"><label className="small text-gray-600" for="leadCapShortProfile" name="short_profile">Tell us about yourself</label><textarea className="form-control rounded-pill" id="leadCapShortProfile" name="short_profile" type="text" rows="4" onChange={handleChange}/></div>
